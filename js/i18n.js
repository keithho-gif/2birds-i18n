...
(function () {
  ...
  var UI = {
    en:      { tag: "Curriculum and Advisory", eyebrow: "Region &amp; Language", title: "Where are you <em>visiting from?</em>",
               note: "Choose your region to view the site in your preferred language.",
               group: "Asia", close: "Close", choose: "Select region" },
    "zh-Hans": { tag: "课程开发与咨询", eyebrow: "地区与语言", title: "您从<em>何处</em>访问？",
               note: "请选择您所在的地区，以您偏好的语言浏览本所网站。",
               group: "亚洲", close: "关闭", choose: "选择地区" },
    "zh-Hant": { tag: "課程開發與顧問", eyebrow: "地區與語言", title: "您從<em>何處</em>造訪？",
               note: "請選擇您所在的地區，以您偏好的語言瀏覽本所網站。",
               group: "亞洲", close: "關閉", choose: "選擇地區" },
    ja:      { tag: "カリキュラムと助言", eyebrow: "地域と言語", title: "どちらから<em>ご覧</em>ですか？",
               note: "ご希望の言語で閲覧いただけるよう、地域をお選びください。",
               group: "アジア", close: "閉じる", choose: "地域を選択" },
    ko:      { tag: "커리큘럼과 자문", eyebrow: "지역 및 언어", title: "어디에서 <em>방문</em>하셨나요?",
               note: "원하시는 언어로 보실 수 있도록 지역을 선택해 주십시오.",
               group: "아시아", close: "닫기", choose: "지역 선택" },
    th:      { tag: "หลักสูตรและการให้คำปรึกษา", eyebrow: "ภูมิภาคและภาษา", title: "คุณเข้าชมจาก<em>ที่ใด?</em>",
               note: "โปรดเลือกภูมิภาคของท่านเพื่อรับชมในภาษาที่ท่านต้องการ",
               group: "เอเชีย", close: "ปิด", choose: "เลือกภูมิภาค" },
    vi:      { tag: "Chương trình giảng dạy và tư vấn", eyebrow: "Khu vực &amp; Ngôn ngữ", title: "Bạn đang <em>truy cập từ đâu?</em>",
               note: "Vui lòng chọn khu vực của bạn để xem bằng ngôn ngữ ưa thích.",
               group: "Châu Á", close: "Đóng", choose: "Chọn khu vực" },
    id:      { tag: "Kurikulum dan penasihatan", eyebrow: "Wilayah &amp; Bahasa", title: "Anda <em>mengunjungi dari mana?</em>",
